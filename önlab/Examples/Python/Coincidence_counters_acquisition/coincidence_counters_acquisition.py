...
DEFAULT_COINCIDENCE_WINDOW = 500

# Default coincidence window in milliseconds (0 or None = endless accumulation of counts)
DEFAULT_COUNTERS_INTEGRATION_TIME = 2000
